...
def tiny_config(tmp_path, enabled=True):
    ...
    save_target_bank(bank, ["TCGA-AA-0001"], np.eye(1, 6, dtype=np.float32), ["breast carcinoma"], "structured")
    return {
        ...
        "molcap": {"enabled": enabled, "targets": str(bank), "target_dim": 6},
    }
